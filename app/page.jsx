...
const features = [
  {
    ...
    desc: "Centralize employee profiles, documents, onboarding, and org charts in one elegant workspace.",
    color: "from-violet-500 to-indigo-500",
  },
  {
    icon: "Clock",
    title: "Attendance Tracking",
    desc: "Real-time attendance with biometric integration, geo-fencing, and shift scheduling.",
    color: "from-cyan-500 to-blue-500",
  },
  {
    icon: "Calendar",
    title: "Leave Management",
    desc: "Automated leave workflows, accrual policies, carry-forward rules, and team calendars.",
    color: "from-emerald-500 to-teal-500",
  },
  {
    icon: "DollarSign",
    title: "Payroll System",
    desc: "Error-free payroll processing with tax calculations, payslips, and compliance reports.",
    color: "from-amber-500 to-orange-500",
  },
  {
    icon: "BarChart",
    title: "Reports & Analytics",
    desc: "Beautiful dashboards with workforce insights, trends, and exportable reports at a glance.",
    color: "from-pink-500 to-rose-500",
  },
  {
    icon: "Shield",
    title: "Role-Based Access",
    desc: "Granular permissions for admins, managers, and employees — zero unauthorized access.",
...
const steps = [
  {
    ...
    desc: "Set up your isolated workspace in under 2 minutes. Configure branding, timezone, and policies.",
  },
  {
    n: "02",
    title: "Add Employees",
    desc: "Bulk import or manually add employees. Send onboarding invites with a single click.",
  },
  {
    n: "03",
    title: "Manage HR Operations",
    desc: "Run payroll, approve leaves, track attendance, and generate reports — all from one place.",
  },
];
...
const benefits = [
  {
    emoji: "⚡",
    title: "Save Time",
    desc: "Automate 80% of repetitive HR tasks so your team can focus on what matters.",
  },
  {
    emoji: "🎯",
    title: "Reduce Errors",
    desc: "Eliminate manual data entry mistakes with smart validations and approval workflows.",
  },
  {
    emoji: "📈",
    title: "Boost Productivity",
    desc: "Streamlined processes mean happier teams and measurable output improvements.",
  },
  {
    emoji: "🏛️",
    title: "Centralized System",
    desc: "One source of truth for all HR data — no more spreadsheets or scattered tools.",
  },
];
...
const testimonials = [
  {
    ...
    stars: 5,
    text: "WorkSphere transformed how we manage 200+ employees. The automation alone saves us 15 hours a week.",
  },
  {
    name: "Marcus Reid",
    role: "COO, Foundry Labs",
    stars: 5,
    text: "The cleanest HR tool I've ever used. Setup took minutes and the team adopted it instantly.",
  },
  {
    name: "Priya Nair",
    role: "People Ops, ScaleUp Inc",
    stars: 5,
    text: "Multi-tenant setup is a game changer. Every department feels like it has its own private workspace.",
  },
];
  ...
  return (
    <div className="flex gap-5 items-start">
      <div className="flex flex-col items-center shrink-0">
        <div
          className="w-12 h-12 rounded-2xl bg-gradient-to-br from-violet-600 to-cyan-500
                        flex items-center justify-center text-white font-black text-sm shadow-lg shadow-violet-500/30"
        >
          {n}
        </div>
        {!isLast && (
          <div className="w-px flex-1 mt-3 bg-gradient-to-b from-violet-500/40 to-transparent h-12" />
        )}
      </div>
        ...
        <div className="flex h-64">
          ...
          <div className="w-12 border-r border-white/8 bg-white/2 flex flex-col items-center py-4 gap-3">
            {["violet", "cyan", "emerald", "amber", "pink"].map((c, i) => (
              <div
                key={i}
                className={`w-7 h-7 rounded-lg bg-${c}-500/20 border border-${c}-500/30`}
              />
            ))}
          </div>
          ...
          <div className="flex-1 p-4 space-y-3">
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                <div
                  key={s.label}
                  className={`rounded-xl p-2.5 bg-gradient-to-br ${s.color} border ${s.border}`}
                >
            ...
            <div className="rounded-xl border border-white/8 bg-white/3 p-3">
              <div className="flex items-end gap-1 h-14">
                {[35, 55, 45, 70, 60, 80, 65, 90, 75, 85, 70, 95].map(
                  (h, i) => (
                    <div
                      key={i}
                      style={{ height: `${h}%` }}
              ...
              <div className="flex justify-between mt-1">
                {[
                  ...
                  <span key={m} className="text-[7px] text-gray-600">
                    {m}
                  </span>
                ))}
              </div>
            ...
            <div className="rounded-xl border border-white/8 bg-white/2 overflow-hidden">
              {[
                ...
                >
                  ...
                  <span
                    className={`flex items-center gap-1 text-[9px] ${e.dot === "bg-emerald-400" ? "text-emerald-400" : "text-amber-400"}`}
                  >
      ...
      {mobileOpen && (
        <div className="md:hidden bg-gray-950/95 backdrop-blur-xl border-t border-white/8 px-6 py-5 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <a
              href="/login"
              className="flex-1 text-center text-sm font-semibold text-gray-300 border border-white/10 rounded-xl py-2.5 hover:bg-white/5"
            >
              Login
            </a>
            <a
              href="/signup"
              className="flex-1 text-center text-sm font-semibold text-white bg-gradient-to-r from-violet-600 to-cyan-500 rounded-xl py-2.5"
            >
              Get Started
            </a>
          </div>
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <p className="mt-6 text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto">
          Streamline employee management, payroll, attendance, and leave — all
          in a single elegant workspace. Built for teams that move fast and
          scale further.
        </p>
        ...
        <div className="mt-8 flex items-center justify-center gap-1">
          ...
          <span className="ml-2 text-sm text-gray-400">
            Rated <strong className="text-white">4.9/5</strong> by 200+ HR teams
          </span>
        </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-400 max-w-xl mx-auto">
            A complete suite of tools designed to replace spreadsheets,
            disconnected apps, and manual processes.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-4 text-gray-400 leading-relaxed">
              WorkSphere is designed for zero-friction setup. No IT team
              required. Just sign up, configure, and go.
            </p>
            ...
            <div className="relative rounded-3xl border border-white/10 bg-gray-900/60 backdrop-blur-xl p-8 space-y-4">
              {[
                ...
                },
                {
                  icon: "🚀",
                  title: "ScaleUp Labs",
                  sub: "48 employees · San Francisco",
                  badge: "Active",
                  badgeColor:
                    "text-emerald-400 bg-emerald-400/10 border-emerald-400/20",
                },
                ...
                <div
                  key={c.title}
                  className="flex items-center gap-4 p-4 rounded-2xl border border-white/8 bg-white/3 hover:bg-white/5 transition-colors"
                >
                  ...
                  <span
                    className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full border ${c.badgeColor}`}
                  >
                    {c.badge}
                  </span>
                </div>
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-black text-white tracking-tight">
                Each company gets
                <br />
                its own secure world
              </h2>
              <p className="mt-5 text-gray-300 leading-relaxed">
                WorkSphere is built on a multi-tenant architecture — every
                organization runs in a fully isolated workspace. Your data never
                touches another company's environment.
              </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={item.title}
                  className={`p-5 rounded-2xl border bg-gradient-to-br ${item.color} ${item.border} text-center`}
                >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="rounded-2xl border border-white/10 bg-gray-900/60 backdrop-blur-xl p-6 space-y-3">
            <div
              className={`h-2 w-24 rounded-full bg-gradient-to-r ${tab === "admin" ? "from-violet-500 to-fuchsia-500" : "from-cyan-500 to-emerald-500"}`}
            />
            ...
            {(tab === "admin"
              ...
              : [
                  ...
                  { label: "Attendance", val: "96.2%", sub: "This month" },
                  {
                    label: "Next Payslip",
                    val: "Nov 30",
                    sub: "₹58,000 estimated",
                  },
                ]
            ).map((stat) => (
              <div
                key={stat.label}
                className="flex items-center justify-between p-3 rounded-xl border border-white/6 bg-white/3"
              >
                <div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="p-6 rounded-2xl border border-white/8 bg-white/3 hover:border-white/20 hover:bg-white/5 transition-all duration-300"
            >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="p-6 rounded-2xl border border-white/8 bg-white/3 hover:border-white/20 hover:bg-white/5 transition-all duration-300 hover:-translate-y-1 text-center group"
            >
        ...
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-violet-900/50 to-cyan-900/30 p-12 sm:p-20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 text-gray-300 text-lg max-w-lg mx-auto">
              Join 500+ companies already using WorkSphere to run efficient,

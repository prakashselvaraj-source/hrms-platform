...
export default function CreateLeaveType({ onBack, onSubmit }) {
  ...
  return (
    <div className="py-6 max-w-3xl w-full  px-4">
      {/* Header */}
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col gap-5 shadow-sm">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full text-sm px-3 py-2 rounded-lg border bg-white text-gray-900 placeholder-gray-400 outline-none focus:ring-2 focus:ring-indigo-400/40 focus:border-indigo-400 transition ${errors.leaveName ? "border-red-400" : "border-gray-200"
              }`}
          />
          {errors.leaveName && (
        ...
        <div>
          ...
          <input
            ...
            maxLength={4}
            placeholder="CL"
            className={`w-full text-sm px-3 py-2 rounded-lg border bg-white text-gray-900 placeholder-gray-400 outline-none focus:ring-2 focus:ring-indigo-400/40 focus:border-indigo-400 transition tracking-widest font-mono uppercase ${errors.leaveCode ? "border-red-400" : "border-gray-200"
              }`}
          />
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-2">
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full transition ${paid ? "bg-indigo-500" : "bg-gray-300"
                  }`}
              >
                <div
                  className={`h-5 w-5 bg-white rounded-full shadow transform transition ${paid ? "translate-x-5" : ""
                    }`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-2">
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full transition ${requiresApproval ? "bg-indigo-500" : "bg-gray-300"
                  }`}
              >
                <div
                  className={`h-5 w-5 bg-white rounded-full shadow transform transition ${requiresApproval ? "translate-x-5" : ""
                    }`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-2">
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full transition ${attachmentRequired ? "bg-indigo-500" : "bg-gray-300"
                  }`}
              >
                <div
                  className={`h-5 w-5 bg-white rounded-full shadow transform transition ${attachmentRequired ? "translate-x-5" : ""
                    }`}
                />
              </button>
            </div>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-1.5 text-[13px] rounded-lg font-medium border transition cursor-pointer ${status === "active"
            ...
            <button
              ...
              className={`px-4 py-1.5 text-[13px] rounded-lg font-medium border transition cursor-pointer ${status === "inactive"
                  ? "bg-[#534AB7] border-[#534AB7] text-[#EEEDFE]"
                  : "bg-white border-gray-200 text-gray-500 hover:bg-gray-50"
                }`}
            >

    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] p-6 md:p-10 font-sans">
            ...
            <div className="flex items-center gap-4 mb-8">
                <button 
                    onClick={() => router.back()}
                    className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-400 hover:text-[#4A45B6] hover:border-[#4A45B6] transition-all"
                >
                    <ArrowLeft size={20} />
                </button>
                <div>
                        ...
                        <div className="relative z-10">
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-3">
                                    ...
                                    <p className="text-[13px] text-white/90 leading-relaxed">Casual leaves must be applied at least 2 days in advance.</p>
                                </li>
                                <li className="flex gap-3">
                                    <div className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center shrink-0 mt-0.5">
                                        <Info size={12} />
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center pb-3 border-b border-gray-50">
                                ...
                                <span className="text-[14px] font-bold text-gray-700">--</span>
                            </div>
                            <div className="flex justify-between items-center pb-3 border-b border-gray-50">

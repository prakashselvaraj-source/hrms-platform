              ...
              <div className="relative flex-shrink-0">
                ...
                <span
                  className={`absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full border-2 ${
                    m.online ? "bg-green-400" : "bg-gray-300"
                  }`}
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 gap-4 p-3 md:p-6 min-w-0 relative">
        ...
        <aside
          className={`lg:hidden fixed top-0 right-0 h-full z-40 w-80 max-w-[90vw] overflow-y-auto p-4 flex flex-col gap-4 transition-transform duration-300 ${
